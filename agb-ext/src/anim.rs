...
impl<'o, Enum: Clone> AnimPlayer<'o, Enum> {
  pub fn new(object: &'o OamManaged, get_next_anim: fn(Enum) -> Anim<Enum>, first_anim: Enum) -> AnimPlayer<'o, Enum> {
    let first_anim = get_next_anim(first_anim);
